...
export class InitV21737335533611 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE TABLE `comments` (`id` int NOT NULL AUTO_INCREMENT, `writerId` int NOT NULL, `questionId` int NOT NULL, `context` varchar(100) NULL, `like` int NOT NULL DEFAULT \'0\', `disLike` int NOT NULL DEFAULT \'0\', `report` int NOT NULL DEFAULT \'0\', `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB COMMENT="Commented on question"');
